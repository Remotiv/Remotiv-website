export const claimSuccessSubject = "Your Remotiv profile has been claimed";

export function renderClaimSuccessEmail(data: {
  ...
  <div style="max-width: 560px; margin: 0 auto; padding: 32px 24px;">
    ...
    <div style="background: #ffffff; border-radius: 16px; padding: 32px; box-shadow: 0 4px 16px rgba(0,0,0,0.05);">
      ...
      <p style="margin: 0 0 24px; color: #555; font-size: 15px; line-height: 1.6;">
        Congratulations — your Remotiv profile is now claimed and linked to your account. You can now log in to edit your details, upload your latest CV, and boost your AI match score.
      </p>

      <!-- CTA -->
      <div style="text-align: center; margin: 24px 0 8px;">
        <a href="${data.dashboardUrl}" style="display: inline-block; background: #7E47FF; color: #ffffff; padding: 14px 28px; border-radius: 10px; text-decoration: none; font-size: 14px; font-weight: 500;">Go to My Dashboard →</a>
      </div>

      <p style="margin: 24px 0 0; color: #888; font-size: 12px; line-height: 1.6;">
        You are receiving this because you claimed a profile on Remotiv.
      </p>
