export const claimInviteSubject =
  "You have been invited to claim your Remotiv profile";
  ...
  <div style="max-width: 560px; margin: 0 auto; padding: 32px 24px;">
    ...
    <div style="background: #ffffff; border-radius: 16px; padding: 32px; box-shadow: 0 4px 16px rgba(0,0,0,0.05);">
      ...
      <p style="margin: 0 0 24px; color: #555; font-size: 15px; line-height: 1.6;">
        The Remotiv team has invited you to claim and manage your profile on our talent platform. Click the button below to log in and claim your profile.
      </p>

      <!-- CTA -->
      <div style="text-align: center; margin: 24px 0 8px;">
        <a href="${data.loginUrl}" style="display: inline-block; background: #7E47FF; color: #ffffff; padding: 14px 28px; border-radius: 10px; text-decoration: none; font-size: 14px; font-weight: 500;">Claim My Profile →</a>
      </div>

      <p style="margin: 24px 0 0; color: #888; font-size: 12px; line-height: 1.6;">
        This invitation was sent by ${data.adminName} via Remotiv. If you did not expect this email, you can ignore it.
      </p>
