...
function ChangePasswordForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // session for `updateUser({ password })`, and re-auth on every typo
    // would burn the per-IP rate-limit budget.
    ...
    // Best-effort: if it fails, still show success — the password update
    // succeeded, and the gated layout will simply re-redirect them here.
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
        ...
        {success ? (
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <Link
              href="/ai-dashboard"
              className="w-full rounded-lg bg-remotiv-purple py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-remotiv-purple-light"
            >
              Go to Dashboard
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3.5 py-3 pr-11 text-sm text-gray-800 outline-none transition-all focus:border-remotiv-purple focus:ring-2 focus:ring-remotiv-purple/20"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="mt-2 w-full rounded-lg bg-remotiv-purple py-2.5 text-sm font-semibold text-white transition-colors hover:bg-remotiv-purple-light disabled:cursor-not-allowed disabled:opacity-60"
            >
